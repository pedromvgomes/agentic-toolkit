...
func render() ([]byte, error) {
	...
	fmt.Fprintln(&b)
	fmt.Fprintln(&b, "Every asset in `definitions/` parses into one of eight category structs. The struct definitions in `internal/definitions/types.go` are the canonical schema; this document is regenerated from them.")
	fmt.Fprintln(&b)
