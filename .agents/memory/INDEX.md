...
24 notes. Read one with `agtk memory show <name>`.
...
## real-git-fixtures-live-in-two-test-packages  (gotcha, verified)
Only internal/cli/tests and internal/sourcestore/tests drive real git subprocesses; a slow package elsewhere is slow for some other reason.

- internal/cli/tests/*.go
- internal/sourcestore/tests/*.go
- internal/curator/tests/*.go
