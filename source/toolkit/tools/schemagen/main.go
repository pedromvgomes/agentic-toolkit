...
// or directly:
//
//	go run ./source/toolkit/tools/schemagen
//
// Output:
...
func render() ([]byte, error) {
	...
	fmt.Fprintln(&b)
	fmt.Fprintln(&b, "<!-- DO NOT EDIT — generated by source/toolkit/tools/schemagen from source/toolkit/internal/definitions struct definitions. Run `go generate ./...` to refresh. -->")
	fmt.Fprintln(&b)
...
func renderConfig() ([]byte, error) {
	...
	fmt.Fprintln(&b)
	fmt.Fprintln(&b, "<!-- DO NOT EDIT — generated by source/toolkit/tools/schemagen from source/toolkit/internal/stack and source/toolkit/internal/lockfile struct definitions. Run `go generate ./...` to refresh. -->")
	fmt.Fprintln(&b)
