---
description: |
  Before submitting any plan for user approval, the agent must run the `challenge`
  skill and submit only the post-challenging plan, with all decisions made explicit.
---
