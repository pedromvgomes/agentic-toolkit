...
<!-- DO NOT EDIT — generated by source/toolkit/tools/schemagen from source/toolkit/internal/definitions struct definitions. Run `make generate` to refresh. -->

Every asset in `definitions/` parses into one of eight category structs. The struct definitions in `source/toolkit/internal/definitions/types.go` are the canonical schema; this document is regenerated from them.
...
| setting | `definitions/settings/<name>.yaml` | YAML manifest (no body) |
